...
insert into trips values ('driver@drive.com', 'Changi Airport T1', 'Sengkang Ave 5', '2017-10-06 11:05:13', 2, 'Toyota', 'Crown', 'available');
insert into trips values ('bullet@concorde.com', 'Pasir Ris Park', 'Woodlands St 9', '2017-10-06 12:44:47', 1, 'Ferrari', 'California', 'available');

insert into bids values ('nondriver@sit.com', 'Blk 122 Punggol East Way', 'Sengkang St 12', 'driver@drive.com', 'Punggol Promenade', 'Sengkang Ave 5', '2016-06-22 19:10:25', 2, 3.20, 'cancelled');
